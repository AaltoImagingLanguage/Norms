function [S,m,l,t,s]=som_grid_scaled(varargin)
...
distances = S.distances / max(max(S.distances));

% Set labels if they exist
% REDNESS1 relevant part
if ~isempty(S.label)
