...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, default='/m/nbe/work/vanvlm1/mnist_data',
                        help='Directory for storing input data')
    parser.add_argument('--log_dir', type=str, default='/m/nbe/work/vanvlm1/mnist-tensorboard-embeddings/logs',
